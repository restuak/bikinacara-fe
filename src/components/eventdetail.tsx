        ...
        <div className="lg:col-span-2 space-y-6">
          <section>
            ...
            <p className="text-black leading-relaxed">
              Experience an intimate live performance by Ujang at the heart
              of Bandung. Join fellow Digital Marketing enthusiasts in a cozy venue,
              featuring a panel of professional Digital Marketers, curated snacks, and an exclusive
              merchandise booth.
            </p>
          </section>
